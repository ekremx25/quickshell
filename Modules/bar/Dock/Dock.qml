...
Variants {
    ...
    PanelWindow {
        ...
        Behavior on margins.bottom { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
        Behavior on margins.top    { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
        Behavior on margins.left   { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
        Behavior on margins.right  { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
        color: "transparent"
        ...
        property var dockModules: [] // Config'den gelen modül listesi
        ...
        function rebuildDockItemsImmediate() {
            ...
            // Add Modules
            for (var m = 0; m < dockModules.length; m++) {
                var modName = dockModules[m];
                items.push({
                    name: modName,
                    isModule: true,
                    moduleName: modName,
                    // Modules don't have typical app properties
                    isPinned: false, isRunning: true, windowId: -1, appId: "module::" + modName
                });
            }
        ...
        Process {
            ...
            onExited: {
                ...
                try {
                    ...
                    dockWindow.dockModules = cfg.modules || [];
        ...
        Process {
            ...
            onExited: {
                ...
                try {
                    dockWindow.runningWindows = JSON.parse(winProc.outputBuffer);
                } catch (e) {
        ...
        function savePinnedApps() {
            var obj = { 
                pinned: pinnedApps,
                modules: dockWindow.dockModules 
            };
            if (dockWindow.dockConfigData) {
                if (dockWindow.dockConfigData.showBackground !== undefined) obj.showBackground = dockWindow.dockConfigData.showBackground;
                if (dockWindow.dockConfigData.dockScale !== undefined) obj.dockScale = dockWindow.dockConfigData.dockScale;
                if (dockWindow.dockConfigData.autoHide !== undefined) obj.autoHide = dockWindow.dockConfigData.autoHide;
            }
        ...
        Rectangle {
            ...
            Row {
                ...
                Item {
                    id: mediaWrapper
                    width: mediaWidget.visible ? mediaWidget.implicitWidth : 0
                                ...
                                MouseArea {
                                    ...
                                    onPositionChanged: (mouse) => {
                                        ...
                                        if (dragStarted) {
                                            ...
                                            // MediaWidget'in genişliğini ve spacing'i çıkar
                                            var mediaOffset = mediaWidget.width + (dockRow.spacing);
                                            var adjustedX = globalPos.x - mediaOffset;
                                            // TODO: This constant width assumption is broken if modules are wider
                                            // But for now modules like Clock/Weather are similar size or small.
                                    ...
                                    onClicked: (mouse) => {
                                        ...
                                        if (mouse.button === Qt.RightButton) {
                                            ...
                                            if (modelData.isRunning && modelData.windowId >= 0) {
                                ...
                                Column {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                // Close logic (need niri capability or window kill)
