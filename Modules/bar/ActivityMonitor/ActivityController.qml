...
Item {
  ...
  // Reading per-process power can fall back to a privileged helper in the
  // upstream plugin. Keep that path disabled in the shell integration.
  property bool processPowerEnabled: false
