...
SlideWindow {
    ...
    headerTools: RowLayout {
        ...
        Rectangle {
            ...
            color: root.wifiEnabled ? Theme.primary : Theme.outline
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: root.currentTab === "wifi" ? Theme.primary : "transparent"
                radius: 6
                Behavior on color { ColorAnimation { duration: 150 } }
                Text { 
                    anchors.centerIn: parent; text: "Wi-Fi"; font.bold: true
                    color: root.currentTab === "wifi" ? Theme.text : Theme.subtext 
                }
                MouseArea { anchors.fill: parent; onClicked: root.currentTab = "wifi" }
            }
            Rectangle {
                Layout.fillWidth: true; Layout.fillHeight: true
                color: root.currentTab === "ethernet" ? Theme.primary : "transparent"
                radius: 6
                Behavior on color { ColorAnimation { duration: 150 } }
                Text { 
                    anchors.centerIn: parent; text: "以太网"; font.bold: true
                    color: root.currentTab === "ethernet" ? Theme.text : Theme.subtext 
                }
    ...
    StackLayout {
        ...
        ColumnLayout {
            ...
            Text { 
                text: "网络列表"; color: Theme.subtext; font.pixelSize: 12
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    border.width: 1
                    border.color: ma.containsMouse ? Theme.primary : "transparent"
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            color: model.connected ? Theme.primary : Theme.subtext
                        ...
                        ColumnLayout {
                            ...
                            Text { 
                                ...
                                color: model.connected ? Theme.primary : Theme.text 
                            }
                            RowLayout {
                                spacing: 4
                                Text { 
                                ...
                                Text { 
                                    ...
                                    font.pixelSize: 11; color: model.connected ? Theme.primary : Theme.subtext 
                                }
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            color: model.connected ? Qt.rgba(Theme.error.r, Theme.error.g, Theme.error.b, 0.15) : Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.15)

                            Text { 
                                anchors.centerIn: parent
                                text: model.connected ? "断开" : "连接"
                                color: model.connected ? Theme.error : Theme.primary
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Text { 
                    ...
                    color: Theme.outline; Layout.alignment: Qt.AlignHCenter
                }
                Text { text: "以太网设置暂不可用"; color: Theme.subtext }
            }
        }
    }
